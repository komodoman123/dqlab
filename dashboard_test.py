...
st.image(image)
st.write("ROI memang cukup tinggi untuk horror namun genre tersebut bukan genre safe yang mungkin ditunjukkan oleh rata-rata, dikarenakan oleh outlier seperti blair witch. Meskipun blair witch memiliki ROI ratus ribuan persen, revenue yang dihasilkan masih kurang dari 1 miliar dollar ")
